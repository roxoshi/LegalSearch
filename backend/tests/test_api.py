...
def test_search_endpoint_basic(client, postgres_db, postgres_sample_document, postgres_sample_chunk):
...
def test_search_endpoint_with_filters(client, postgres_db, postgres_sample_document, postgres_sample_chunk):
...
def test_search_endpoint_pagination(client, postgres_db, postgres_sample_document, postgres_sample_chunk):
